...
|---|---|---|---|---|---|---|---|---|
| 11 | Models and inference | COMMITTED | TBD | Lyceum (lyceum.technology) | | no | — | Likely contact: Magnus Gruenewald, Co-Founder and CEO (per their site); need confirmed name, title, headshot |
...
| 17 | Identity, permissions, and security | COMMITTED | TBD | kontext.security | | no | — | Get founder name, title, square headshot |
